...
const
  MAX_COL_SOLDIER=30;
  COL_ACTION_MAX=40;        // количество действий
  COL_FRAME_MAX=400;        // количество кадров
  COL_ELEMENT_MAX=40;       // количество Элементов человека
  COL_MAX_ACTION_ORDER=30;  // количество действий в очереди
...
type
  ...
  TSoldier=record
    tekX        : real;       // Текущее положение
    tekY        : real;
    tekH        : real;
    rotateCenter: real;     // Поворот по азимуту
    action      : word;     // действие
    frame       : word;     // номер кадра
    enable      : boolean;
  end;
...
procedure LoadAnimationInterpol;   // Исключил загрузку анимации человека
var
  s     : string;
  f     : textfile;
  a,b,c : word;
