...
begin
  n_haus:=-1;
  case typ of
    23: AddMestnikForCollis(STOLB_WHITE,a,x,y,h,0,t);//Черный столбик
    24: AddMestnikForCollis(STOLB_RED,a,x,y,h,0,t);  //Красный столбик
    25: AddMestnikForCollis(STOLB_BLUE,a,x,y,h,0,t); //Голубой столбик
    // Деревья
    110,120,130: begin
      t:=1+Random(5)/8;
    ...
    124: AddMestnikForCollis(VYCHKA,a,x,y,h,0,t); //Вышка
    // Участки леса
    150: begin
      t:=0.81+Random(5)/8;
    ...
    194: AddMestnikForCollis(ZNAK1,a,x,y,h,0,t); //Знак 1
    195: AddMestnikForCollis(ZNAK2,a,x,y,h,0,t); //Знак 2
    196: AddMestnikForCollis(ZNAK3,a,x,y,h,0,t); //Знак 3
    197: AddMestnikForCollis(ZNAK_STOP,a,x,y,h,0,t); //Знак стоп
    198: AddMestnikForCollis(STOLB_BLACK,a,x,y,h,0,t); //Черный столбик
    ...
    400: begin
      AddMestnikForCollis(BASH_KR,a,x,y,h,0,t); //Водонапорная
    end;
    410: AddMestnikForCollis(CERCOV,a,x,y,h,0,t);   //Церковь
    430: AddMestnikForCollis(STOLB_V,a,x,y,h,0,t);  //Столб В
    420: AddMestnikForCollis(STOLB_E,a,x,y,h,0,t);  //Столб Е
    450: AddMestnikForCollis(ZABOR,a,x,y,h,0,t);    //Забор
    451: AddMestnikForCollis(ZABOR+1,a,x,y,h,0,t);  //Забор
    460: AddMestnikForCollis(ZABOR+2,a,x,y,h,0,t);  //Забор
    461: AddMestnikForCollis(ZABOR+3,a,x,y,h,0,t);  //Забор
    462: AddMestnikForCollis(ZABOR+4,a,x,y,h,0,t);  //Забор
    463: AddMestnikForCollis(ZABOR+5,a,x,y,h,0,t);  //Забор
    800: AddMestnikForCollis(BASH_KR,a,x,y,h,0,t);
    801: AddMestnikForCollis(BASH_KV,a,x,y,h,0,t);
    850: AddMestnikForCollis(OKOP_1,a,x,y,h,0,t);   //Окоп
    851: AddMestnikForCollis(OKOP_2,a,x,y,h,0,t);   //Окоп
    852: AddMestnikForCollis(OKOP_3,a,x,y,h,0,t);   //Окоп
    855: AddMestnikForCollis(MOST_KOL1,a,x,y,h,0,t);//Колейный мостик
    860: AddMestnikForCollis(PEREEZD,a,x,y,h,0,t);  //Переезд
    861: AddMestnikForCollis(ZNAK_G_D,a,x,y,h,0,t); //Знак переезл
    862: AddMestnikForCollis(OZERO,a,x,y,h,0,t);    //Озеро
  end;
end;
